...
class YahooFinanceAPI {
   ...
   * @return {Promise}
   */
  getIntradayChartData(ticker, interval = '2m', range = '1d', prePostData = true) {
    const query = `https://query1.finance.yahoo.com/v8/finance/chart/${ticker}?range=${range}&includePrePost=${prePostData}&interval=${interval}&corsDomain=finance.yahoo.com&.tsrc=finance`;
    return this.ajax(query);
  }
